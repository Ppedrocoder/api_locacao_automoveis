def get_links(locacao_id: int, status: str):
    base = f"/api/locacoes/{locacao_id}"
    ...
    if status == "RESERVADO":
        ...
        links.append({"rel": "pagamento", "href": f"/api/pagamentos/?locacao_id={locacao_id}", "method": "GET"})
